   ...
   <div id="maincontent" class="span9 pull-right">
            <div id="myTabContent" class="tab-content">
                ...
                <form action="facultyprofile.jsp" method="post">
                    <center><h1 style='color:#808080;'> SPORTQUIZ ScoreCard: </h1></center><br/>
              ...
              <table id='sortTableExample' class='table zebra-striped'>
                ...
                <tbody>
                          ...
                          <tr style="font-weight:bold;">
                              <td>25</td>
                              <td>rachanabagde1996@gmail.com</td>
                              <td>32</td>
                              <td>9</td>
                              <td>9</td>
                              <td>119</td>
...
<td>testing</td>
 ...
 <script>
  ...
  ga('create', 'UA-46740849-1', 'codeshare.in');
  ga('send', 'pageview');
...
<!--
<script type="text/javascript" src="https://mylivechat.com/chatinline.aspx?hccid=22456266"></script>
-->

<script type="text/javascript" src="https://mylivechat.com/chatinline.aspx?hccid=32489471"></script>
...
<div class="navbar navbar-fixed-bottom" style=" margin-bottom: 0px">
           ...
           <center style="color:black"><a href="#myModal3"  data-toggle="modal" ><b>Contact Us</b></a> || <a href="#myModal" data-toggle="modal"><b>Feedback</b></a></center>
            <p style="color: black; text-align: center; margin-left: 100px " align="center">Copyright &copy; 2021 Online Examination System, All rights reserved 
            <img style="float: right;" src="http://www.e-zeeinternet.com/count.php?page=1022996&style=odometer&nbdigits=9&reloads=1" alt="Hit Counter" border="0" ><br/><a href="#" title="Hit Counter" target="_blank" style="font-family: Geneva, Arial, Helvetica, sans-serif; font-size: 10px; color: #000000; text-decoration: none;">
           </a>
            </p>
            
        <center style="color: white">Please help us to improve the website by your feedback.</center>
</div>
</div>
       </div>
...
<div id="myModal3" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div align="center" class="modal-body lead" style='color:#808080 ;font-weight: bold;' >
        ...
        <p>
           Saloni Koya </p>
        <p>
            Email : <a href="mailto:saloni19koya@gmail.com">saloni19koya@gmail.com</a>  </p>
         <p>
            Mobile : +91 9725509531 </p>
         <br />
