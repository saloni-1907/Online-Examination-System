...
<a href="index.jsp" class="brand"> <img src="./assets/img/daiict.jpg" alt="Exam Show" width="100px" height="120px"/></a>
<br/>
<h1 class="brand" style="font-weight: bold; font-size: 25px; color: white;">Online Examination System</h1>

<h3 class="brand" style="font-weight:bold;"><a href="index.jsp" style="color:white;margin-left:30px;">Home</a></h3>
<h3 class="brand" style="font-weight:bold;"><a href="upcomingevents.jsp"  style="color:white">Events<img src="assets/img/new.gif" border="0" style="margin-top: -10px""/></a></h3>
