...
<c:if
	test='${(not empty param["Unavailable"]) || (not empty param["ErrorCode"]) || (not empty param["NotGiven"])}'>
active
</c:if>



<form action="result.jsp" id="contact-form" class="form-horizontal"
	method="post">
...
<span class="add-on"><i class="icon-barcode"></i></span> <input
	type="text" class="input-large" name="scode" id="scode" required="true"
	placeholder="Subject Code" />
</div>

<c:if test='${not empty param["Unavailable"]}'>
	<p style='font-weight: bold; color: green'>Result will be available
	after contest ends.</p>
</c:if>

<c:if test='${not empty param["NotGiven"]}'>
	<p style='font-weight: bold; color: red'>You have not given this
	Exam.</p>
</c:if>
...
<c:if test='${not empty param["alreadygiven"]}'>
	<p style='font-weight: bold; color: red'>You have already Given
	this Paper..</p>
</c:if>
...
<span class="add-on"><i class="icon-book"></i></span> <input
	...
	placeholder="Current Password" required="true" onkeyup="loadXMLDoc()" />
<span id="err"> </span>
</div>
</div>
</div>
...
<div class="input-prepend">
<span class="add-on"><i class="icon-barcode"></i></span> <input
	type="password" class="input-large" name="apasswd" id="apasswd"
...
<div class="input-prepend">
<span class="add-on"><i class="icon-barcode"></i></span> <input
	type="password" class="input-large" name="conpasswd" id="conpassword"
	required="true" placeholder="New Password" />
</div>
</div>
</div>
...
<div class="controls">
<c:if test='${not empty param["Success"]}'>
	<p style="color: green; font-weight: bold;">Your Password is
