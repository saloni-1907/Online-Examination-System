...
<a href="#" class="brand"> <img src="./assets/img/daiict.jpg" alt="Exam Show" width="100px" height="120px"/></a>
<br/>
<h1 class="brand" style="font-weight: bold;color:white;margin-left:600px;font-size:40px;">Online Examination System</h1>
...
String user = (String)session.getAttribute("studentid");
            ...
            {
                    out.println("<b> Welcome , <a href='studentprofile.jsp' style='color:white;font-size:20px;'>" +uname+ "</a></b>");
            }
%>
&nbsp;&nbsp;
</p>
        ...
        try {
            ...
            if(rs1.next())
            {
               ...
               if(rs1.next())
               {
                   ...
                   {
                        //contest ended
                        qry = "select * from examshow.result"+scode+" where username='"+user+"'";
