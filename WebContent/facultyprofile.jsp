		...
		<div class="row">
			...
			<div class="span2">
				<ul class="nav nav-tabs nav-stacked nav-justified"
					...
					<li><a href="#addsub" data-toggle="tab">Add Subject</a></li>
					<li><a href="#makepaper" data-toggle="tab">Make Paper</a></li>
					<li><a href="#updatepaper" data-toggle="tab">Update Paper</a>
					</li>
					<li><a href="#viewpaper" data-toggle="tab">View Paper</a></li>
					<li><a href="#viewresult" data-toggle="tab">View Result</a></li>
					<li><a href="#appendpaper" data-toggle="tab">Append Paper</a>
					</li>
					<li><a href="#deletepaper" data-toggle="tab">Delete Paper</a>
					</li>
...
active
      ...
      ">
						<div class="span10">
							<center>
								<img src="assets/img/background_img.jpg" alt="Online Exam System"
					...
					<div id="profile" class="tab-pane fade in">
						...
						try {
							...
							out.println("<table class='table table-hover' style='background:white;color:#808080;' >");
						%>
					...
					<div id="addsub" class="tab-pane">
						...
						<form action="addsubject" id="contact-form"
							...
							<div class="control-group">
								...
								<div class="controls">
									<button type="submit" class="btn btn-success" style="background: #330099">Submit</button>
								</div>
							</div>
						</form>
...
active
                    ...
                    ">
						...
						<form action="updatepaper.jsp" id="contact-form"
							...
							<center>
								<button type="submit" class="btn btn-success"  style="background: #330099">Update</button>
							</center>
						</form>
              ...
              ">
						...
						<form action="viewpaper.jsp" id="contact-form"
							...
							<div class="control-group">
								<label class="control-label"></label>
								<div class="controls">
									<button type="submit" class="btn btn-primary"  style="background: #330099">View
										Paper</button>
								</div>
							</div>
						</form>
              ...
              ">
						...
						<form action="makepaper.jsp" id="contact-form"
							...
							<div class="control-group">
								<label class="control-label"></label>
								<div class="controls">
									<button type="submit" class="btn btn-primary"  style="background: #330099">Append
										Paper</button>
								</div>
							</div>
						</form>
